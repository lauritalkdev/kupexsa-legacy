  ...
  return (
    <main className="min-h-screen bg-gray-50">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-yellow-400/30 bg-gradient-to-br from-blue-900 via-blue-950 to-black p-7 shadow-2xl sm:p-8">
            ...
            <div className="relative">
              <div className="flex items-start justify-between gap-6">
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-yellow-400/50 bg-yellow-400/10 text-sm font-bold text-yellow-300">
                  KPX
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-6 text-sm">
                ...
                <div>
                  ...
                  <span className="mt-1 inline-flex rounded-full bg-yellow-400/15 px-3 py-1 font-semibold text-yellow-300">
                    Pending Approval
                  </span>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pt-10">
        <div className="flex flex-col gap-4 rounded-2xl border border-yellow-200 bg-yellow-50 p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="font-bold text-blue-950">
              Your account is awaiting KUPEXSA approval
            </h2>

            <p className="mt-1 text-sm leading-6 text-gray-600">
              You can explore the dashboard while your membership information
              is being reviewed.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-gray-600">
            These figures will update automatically when the dashboard is
            connected to the KUPEXSA database.
          </p>
        </div>
